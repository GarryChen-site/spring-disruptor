package statefulj.persistence.memory;

import statefulj.fsm.Persistent;
import statefulj.fsm.StaleStateException;
import statefulj.fsm.model.State;
import statefulj.persistence.StateFieldAccessor;
...
public class MemoryPersistentImpl<T> implements Persistent<T> {
    ...
    private synchronized Field locateStateField(final T stateful) {
        ...
        //
            ...
            field = ReflectionUtils.getFirstAnnotatedField(stateful.getClass(), statefulj.persistence.annotations.State.class);
            if (field != null) {

...
import com.garry.springlifecycle.annotation.pointcut.After;
import com.garry.springlifecycle.annotation.pointcut.Before;
...
public class BeforeAfterMethodTarget  {
	...
	public Object invoke(Method invokedmethod, Object[] args, MethodProxy methodProxy) throws Throwable, Exception {
		...
		Object result = null;
		try {
			Debug.logVerbose("<----->FixedMethodInvocation begin:", module);

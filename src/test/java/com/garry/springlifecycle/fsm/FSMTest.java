...
import com.garry.springlifecycle.fsm.statefulj.fsm.model.impl.StateActionPairImpl;
import com.garry.springlifecycle.fsm.statefulj.fsm.model.impl.StateImpl;
import com.garry.springlifecycle.fsm.statefulj.fsm.model.impl.WaitAndRetryActionImpl;
...
public class FSMTest {
	...
	public void testSimpleFSM() throws TooBusyException, RetryException {
		...
		Persistent<Foo> persistent = new MemoryPersistentImpl<Foo>(stateful, states, stateA);
		FSM<Foo> fsm = new FSM<Foo>("SimpleFSM", persistent);
	...
	public void testNonDeterminsticTransition() throws TooBusyException {
		...
		Persistent<Foo> persister = new MemoryPersistentImpl<Foo>(stateful, states, stateA);
	...
	public void testConcurrency() throws TooBusyException, InterruptedException, RetryException {
		...
		Persistent<Foo> persister = new MemoryPersistentImpl<Foo>(states, stateA);
	...
	public void testTooBusy() {
		...
		Persistent<Foo> persister = new MemoryPersistentImpl<>(stateful, states, stateA);
	...
	public void testStateFieldName() {
		...
		MemoryPersistentImpl<Foo2> persister = new MemoryPersistentImpl<Foo2>(stateful, states, stateA, "state");

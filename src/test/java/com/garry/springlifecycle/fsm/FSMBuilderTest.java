...
public class FSMBuilderTest {
    ...
    public void testBuildTransition2() throws TooBusyException {
        com.garry.springlifecycle.fsm.statefulj.fsm.model.State<FooState> barState = new StateImpl<FooState>("BAR");
        FooState fooState = new FooState();
        this.fooStateFSM =  FSM.FSMBuilder
                .newBuilder(FooState.class)
                .buildState("FOO")
    ...
    public void testAddPersister() throws TooBusyException {
        MemoryPersistentImpl<FooState> persister = new MemoryPersistentImpl();
        this.fooStateFSM =  FSM.FSMBuilder
                .newBuilder(FooState.class)
                .setPersistent(persister)
                .buildState("FOO")
                .done()
                .buildState("BAR")
                .done()
        ...
        assertEquals(persister, fooStateFSM.getPersistent());
